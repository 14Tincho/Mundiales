...
<table class="table table-sm table-striped table-hover text-center table-listado ">
    ...
    <tbody>
        ...
        <?php if ($i==1) {?>
        <tr class="text-white">
            <td><?= $finales['nropartido'] ?></td>
            <td><?= $finales['id_final'] ?></td>
            <td><strong><?= $finales['equipo'] ?></strong></td>
            <td><?= $finales['goles'] ?></td>
            <td><?= $finales['penales'] ?></td>
        <?php } ?>
        <?php if ($i==2) {?>
            <td><?= $finales['id_final'] ?></td>
            <td><strong><?= $finales['equipo'] ?></strong></td>
            ...
            <td><?= $finales['penales'] ?></td>
            <td>
                <a href="nos-finales-editar.php?id_editar=<?= $finales['nropartido'] ?>" class="a-listado">Editar</a>
            </td>
        </tr>
        <?php } ?>
        <?php endwhile; ?>
