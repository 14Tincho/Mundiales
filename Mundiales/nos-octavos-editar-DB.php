...
if ($penales1 == NULL && $penales2 == NULL) {
    $sql = "UPDATE octavos SET goles = $goles1 WHERE nropartido = $nropartido AND posicion = 1";
    $rs = mysqli_query($link, $sql);
    $sql = "UPDATE octavos SET goles = $goles2 WHERE nropartido = $nropartido AND posicion = 2";
    $rs = mysqli_query($link, $sql);
}else {    
