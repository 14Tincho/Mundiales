<table class="table table-sm table-striped table-hover text-center table-listado">
    ...
    <tbody>
        ...
        <tr class="text-white">
            ...
            <td><?= $equipo['anio'] ?></td>
            <td>
                <a href="nos-equipos-editar.php?id_editar=<?= $equipo['id_equipo'] ?>" class="a-listado">Editar</a>
            </td>
            <td>
                <a href="nos-equipos-eliminar.php?id_eliminar=<?= $equipo['id_equipo']?>" onclick="return confirm('Estás seguro de querer el equipo <?= $equipo['nombre']; ?>?');" class="a-listado">Eliminar</a>
            </td>
        </tr>
        <?php endwhile; ?>
    </tbody>
