...
<nav class="navbar navbar-expand-md navbar-dark fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbar_principal">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <!-- <a class="nav-link" href="nos-index.php?$pedo='trolo'" onclick="return confirm('¿Seguro que quieres guardar los cambios?');">Guardar Posicion Total</a> -->
                <a class="nav-link" href="nos-guardar-pos-tot.php" onclick="return confirm('¿Seguro que quieres guardar los cambios?');">Guardar Posicion Total</a>
            </li>        
            <li class="nav-item">
